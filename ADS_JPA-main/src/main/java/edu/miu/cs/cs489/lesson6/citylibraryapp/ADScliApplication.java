...
public class ADScliApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Create patients
        Patient patient1 = new Patient(null, "Gillian", "White", "gillian@example.com", "1234567890", address1, new ArrayList<>());
        ...
        // Create appointments
        Appointment appointment1 = new Appointment(null, LocalDate.of(2013, 9, 12), surgery1, patient1, dentist1);
